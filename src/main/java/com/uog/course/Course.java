...
public class Course {
	...
	private long QUALIFICATIONTYPE_ID;
	private long PROVISIONTYPE_ID;
	private long REGULATORYBODY_ID;
	private long TEACHERTRAININGCOURSE_ID;
	...
	public static String filePath = "E:\\CSV Academics\\Courses.csv";
	...
	public long getQUALIFICATIONTYPE_ID() {
		return QUALIFICATIONTYPE_ID;
	}

	public void setQUALIFICATIONTYPE_ID(long qUALIFICATIONTYPE_ID) {
		QUALIFICATIONTYPE_ID = qUALIFICATIONTYPE_ID;
	}

	public long getPROVISIONTYPE_ID() {
		return PROVISIONTYPE_ID;
	}

	public void setPROVISIONTYPE_ID(long pROVISIONTYPE_ID) {
		PROVISIONTYPE_ID = pROVISIONTYPE_ID;
	}

	public long getREGULATORYBODY_ID() {
		return REGULATORYBODY_ID;
	}

	public void setREGULATORYBODY_ID(long rEGULATORYBODY_ID) {
		REGULATORYBODY_ID = rEGULATORYBODY_ID;
	}

	public long getTEACHERTRAININGCOURSE_ID() {
		return TEACHERTRAININGCOURSE_ID;
	}

	public void setTEACHERTRAININGCOURSE_ID(long tEACHERTRAININGCOURSE_ID) {
